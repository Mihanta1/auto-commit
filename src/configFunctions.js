...
function getGitCredentials() {
    var username = process.env.GIT_USERNAME || "default-username";
    var password = process.env.GIT_PASSWORD || "default-password";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, git.addConfig("user.name", username)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, git.addConfig("user.password", password)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function toggleBotAction(enable) {
    ...
    console.log("Bot action is now ".concat(enable ? "enabled" : "disabled", "."));
}
